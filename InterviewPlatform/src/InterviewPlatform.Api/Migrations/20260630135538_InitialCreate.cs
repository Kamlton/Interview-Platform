        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PreviousWorkplace = table.Column<string>(type: "text", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CompetencyMatrices_Users_CreatedByUserId",
                        column: x => x.CreatedByUserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_CompetencyMatrices_Vacancies_VacancyId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Interviews_CompetencyMatrices_MatrixId",
                        column: x => x.MatrixId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MatrixCompetencies", x => new { x.MatrixId, x.CompetencyId });
                    table.ForeignKey(
                        name: "FK_MatrixCompetencies_Competencies_CompetencyId",
                        column: x => x.CompetencyId,
                        principalTable: "Competencies",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_MatrixCompetencies_CompetencyMatrices_MatrixId",
                        column: x => x.MatrixId,
                        principalTable: "CompetencyMatrices",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_CompetencyScores_Interviews_InterviewId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Comment = table.Column<string>(type: "text", nullable: true),
                    MadeByUserId = table.Column<Guid>(type: "uuid", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Decisions_Interviews_InterviewId",
                        column: x => x.InterviewId,
                        principalTable: "Interviews",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Decisions_Users_MadeByUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_GeneratedDocuments_Interviews_InterviewId",
                        column: x => x.InterviewId,
                        principalTable: "Interviews",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CompetencyMatrices_CreatedByUserId",
                table: "CompetencyMatrices",
                column: "CreatedByUserId");

            migrationBuilder.CreateIndex(
                name: "IX_CompetencyMatrices_VacancyId",
                table: "CompetencyMatrices",
                column: "VacancyId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CompetencyScores_InterviewId_CompetencyId",
                table: "CompetencyScores",
                columns: new[] { "InterviewId", "CompetencyId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Decisions_InterviewId",
                table: "Decisions",
                column: "InterviewId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Decisions_MadeByUserId",
                table: "Decisions",
                column: "MadeByUserId");

            migrationBuilder.CreateIndex(
                name: "IX_GeneratedDocuments_InterviewId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MatrixCompetencies_CompetencyId",
                table: "MatrixCompetencies",
                column: "CompetencyId");
